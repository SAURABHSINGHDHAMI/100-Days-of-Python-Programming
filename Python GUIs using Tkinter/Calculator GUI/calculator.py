...
# Initialize variables for first number, second number, and operator
first_number = second_number = operator = None

# Function to append a digit to the current result label text
def get_digit(digit):
...
# Function to set the operator and update the first number
def get_operator(op):
...
# Create and configure number buttons (7, 8, 9)
...
# Create and configure number buttons (4, 5, 6)
...
# Create and configure number buttons (1, 2, 3)
...
# Create and configure clear, zero, equals buttons (C, 0, =)
